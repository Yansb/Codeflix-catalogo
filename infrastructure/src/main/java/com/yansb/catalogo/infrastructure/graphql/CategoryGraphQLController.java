package com.yansb.catalogo.infrastructure.graphql;

import com.yansb.catalogo.application.category.list.ListCategoryOutput;
...
import com.yansb.catalogo.infrastructure.category.models.CategoryDTO;
...
public class CategoryGraphQLController {
    ...
    public CategoryGraphQLController(ListCategoryUseCase listCategoryUseCase, SaveCategoryUseCase saveCategoryUseCase) {
    ...
    public Category saveCategory(
            @Argument final CategoryDTO input
    ) {
